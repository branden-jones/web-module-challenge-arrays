...
function getRandomFlavors(array1, array2, array3, array4){
  let randomArray = array1.concat(array2, array3, array4);
    let random31 = [...randomArray].sort(() => .5 -Math.random());
    return random31.slice(0,31)
}; 
console.log(getRandomFlavors(originalFlavors,newFlavors,regionalFlavors,seasonalFlavors));
//this returns duplicates... so that stinks...
